...
export default function AdminPedidosPage() {
  ...
  const actualizarEstadoPedido = async (pedidoId: string, nuevoEstado: string) => {
    try {
      ...
      // Ya no necesitamos actualizar el estado local aquí
      // porque la suscripción se encargará de eso
    } catch (error) {
      console.error('Error al actualizar el estado:', error);
                ...
                <div className="flex justify-between items-start mb-4">
                  <div className="space-y-2">
                    <p className="text-sm text-gray-600">
                      Usuario: <span className="font-medium">{pedido.nombreusuario}</span>
                    </p>
                    <p className="text-sm text-gray-600">
                    ...
                    <p className="text-sm text-gray-600">
                      Ubicación: {pedido.identificadorubicacion}
                    </p>
                  </div>
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="ml-4 block w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    >
